(function() {
    ...
    function setupEventListeners() {
        ...
        // Add event listeners for the new buttons in strategy subboxes
        document.querySelectorAll('.strategy-subbox').forEach(strategySubbox => {
            const addAngleBtn = strategySubbox.querySelector('.add-angle-btn');
            if (addAngleBtn) {
                addAngleBtn.addEventListener('click', () => addAngle());
            }

            const addScriptBtn = strategySubbox.querySelector('.add-script-btn');
            if (addScriptBtn) {
                addScriptBtn.addEventListener('click', () => addScript());
            }

            const addVariantBtn = strategySubbox.querySelector('.add-variant-btn');
            if (addVariantBtn) {
                addVariantBtn.addEventListener('click', () => addVariant());
            }
        });

        // Add event listeners for the new buttons in angle subboxes
        document.querySelectorAll('.angle-subbox').forEach(angleSubbox => {
            const addScriptBtn = angleSubbox.querySelector('.add-script-btn');
            if (addScriptBtn) {
                addScriptBtn.addEventListener('click', () => addScript());
            }

            const addVariantBtn = angleSubbox.querySelector('.add-variant-btn');
            if (addVariantBtn) {
                addVariantBtn.addEventListener('click', () => addVariant());
            }

            const addStrategyBtn = angleSubbox.querySelector('.add-strategy-btn');
            if (addStrategyBtn) {
                addStrategyBtn.addEventListener('click', () => addStrategy());
            }
        });

        // Add event listeners for the new buttons in script subboxes
        document.querySelectorAll('.script-subbox').forEach(scriptSubbox => {
            const addVariantBtn = scriptSubbox.querySelector('.add-variant-btn');
            if (addVariantBtn) {
                addVariantBtn.addEventListener('click', () => addVariant());
            }

            const addStrategyBtn = scriptSubbox.querySelector('.add-strategy-btn');
            if (addStrategyBtn) {
                addStrategyBtn.addEventListener('click', () => addStrategy());
            }

            const addAngleBtn = scriptSubbox.querySelector('.add-angle-btn');
            if (addAngleBtn) {
                addAngleBtn.addEventListener('click', () => addAngle());
            }
        });

        // Add event listeners for the new buttons in variant subboxes
        document.querySelectorAll('.variant-subbox').forEach(variantSubbox => {
            const addScriptBtn = variantSubbox.querySelector('.add-script-btn');
            if (addScriptBtn) {
                addScriptBtn.addEventListener('click', () => addScript());
            }

            const addAngleBtn = variantSubbox.querySelector('.add-angle-btn');
            if (addAngleBtn) {
                addAngleBtn.addEventListener('click', () => addAngle());
            }

            const addStrategyBtn = variantSubbox.querySelector('.add-strategy-btn');
            if (addStrategyBtn) {
                addStrategyBtn.addEventListener('click', () => addStrategy());
            }
        });
    ...
    function addStrategy() {
        ...
        strategySubbox.innerHTML = `
            ...
            <div class="subbox-content">
                ...
                <div class="arrow-button-container right-aligned">
                    <div class="arrow-right"></div>
                    <div class="subbox-buttons right-aligned">
                        <button class="add-angle-btn small-btn">Add Angle</button>
                        <button class="add-script-btn small-btn">Add Script</button>
        ...
        strategySubbox.querySelector('.add-angle-btn').addEventListener('click', () => addAngle(strategyCount));
        strategySubbox.querySelector('.add-script-btn').addEventListener('click', () => addScript(strategyCount));
        strategySubbox.querySelector('.add-variant-btn').addEventListener('click', () => addVariant(strategyCount));
    ...
    function addAngle(strategyNumber) {
        ...
        angleSubbox.innerHTML = `
            ...
            <div class="subbox-content">
                ...
                <div class="arrow-button-container left-aligned">
                    <div class="arrow-left"></div>
                    <div class="subbox-buttons">
                        <button class="add-strategy-btn small-btn">Add Strategy</button>
                    </div>
                </div>
            </div>
        `;
        ...
        angleSubbox.querySelector('.add-script-btn').addEventListener('click', () => addScript(strategyNumber, angleCount));
        angleSubbox.querySelector('.add-variant-btn').addEventListener('click', () => addVariant(strategyNumber, angleCount));
        angleSubbox.querySelector('.add-strategy-btn').addEventListener('click', () => addStrategy());
    ...
    function addScript(strategyNumber, angleNumber) {
        ...
        scriptSubbox.querySelector('.add-strategy-btn').addEventListener('click', () => addStrategy());
        scriptSubbox.querySelector('.add-angle-btn').addEventListener('click', () => addAngle());
    ...
    function addVariant(scriptSubbox) {
        ...
        variantSubbox.querySelector('.add-script-btn').addEventListener('click', () => addScript());
        variantSubbox.querySelector('.add-angle-btn').addEventListener('click', () => addAngle());
        variantSubbox.querySelector('.add-strategy-btn').addEventListener('click', () => addStrategy());
    ...
    function updateAngleStats(angleSubbox) {
        ...
        const stats = `${scriptCount} scripts, ${variantCount} variants`;
        angleSubbox.querySelector('.angle-stats').textContent = stats;
    }
    ...
    function updateScriptStats(scriptSubbox) {
        ...
        const stats = `${variantCount} variants`;
        scriptSubbox.querySelector('.script-stats').textContent = stats;
    }
